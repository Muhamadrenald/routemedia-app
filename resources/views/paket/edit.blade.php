        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-800 dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <!-- Header Section -->
                    <div class="mb-6">
                        <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">Edit Informasi Paket Internet</h3>
                        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                            Perbarui data paket internet yang ada di sistem.
                        </p>
                    </div>
